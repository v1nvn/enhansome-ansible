...
* [aar-doc - Automated Ansible Role Documentation](https://github.com/telekom-mms/Automated-Ansible-Role-Documentation) ⭐ 50 | 🐛 8 | 🌐 Python | 📅 2026-02-17 - Generate documentation automatically from an Ansible role's metadata.
...
* [Emacs](https://www.gnu.org/software/emacs/) - A free, open-source text editor and IDE that supports auto-indentation, syntax highlighting and a built in terminal shell (among other things):
  * [magit-mode](https://github.com/magit/magit) ⭐ 7,025 | 🐛 11 | 🌐 Emacs Lisp | 📅 2026-02-17 - Git porcelain within Emacs.
